...
| metric | value |
|---|---|
| completeness | scope=full · 14/14 results present (0 missing, 0 heldout missing) · reps=1 · datasetHash=e8f3f6a5d165 · COMPLETE |
...
| reduce | offline-fixtures | red-rec-001-recency-population | 0 | development | scored | yes | — |
| reduce | offline-fixtures | red-rec-002-timestamp-adversarial | 0 | heldout | scored | yes | (hidden) |
