...
| 5.5 Stage 5 — freeze, final audit, deploy | **DEPLOYED 2026-09-11** — `45fa81f` live, 0028–0030 applied 22:35:37Z, drain live; first window green 02:23Z; entries signed `d499c42`; nights 2–3 owed | first window: yes |
...
- 2026-09-11 14:10 ET — #99 merged 1204ef9 (AUD-02…06, twelfth archive pass, T3-c + C13-b/C10-b signed, #121). Step 27 card sheet `2026-09-11-48h-step27-deploy-cards.md`. Next: step 27, cards 27.0 → 27.12.
...
- 2026-09-12 ≈03:00Z — Step-25 closing entry signed and step-27 deploy entry appended (`d499c42`, UNSIGNED 0, AGENTS.md 140,449 bytes); pushed. PR #100 (`docs/branding-strategy-20260909`, docs-only, outside the program) merged `71953c8` after its worktree was re-added at `/Users/go/code/bnow-net-branding-strategy-20260909`.
- 2026-09-12 12:30Z — Post-deploy docs pass: CURRENT-STATE first bullet = the 09-11 release (was still "production is 8a19ade"); PROGRESS step-27 block; handoff §9 addendum (#121–#124 into Wave 1, three standing lessons, `.env.local` posture + Neon retention + worktree cleanup decisions owed); AGENTS.md OpenSanctions standing row corrected to DARK; #122 status (key blanked ≈01:30Z); observation prompt groups error-level runtime_logs by message. Operator: `OPENSANCTIONS_API_KEY` blanked in Production ≈01:30Z 09-12 (takes effect at the next production deploy).
